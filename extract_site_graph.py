...
def load_site_info(data_dir: str = "SYS_SITE_0306") -> dict:
    """
...
def main():
    # 加载NE到站点的映射
    print("加载NE站点映射...")
    ne_site_map = load_ne_site_mapping()
    ...
    # 生成站点传播图
    print("\n生成站点传播图...")
    site_links = build_site_graph('sys_link_1231.jsonl', ne_site_map)
