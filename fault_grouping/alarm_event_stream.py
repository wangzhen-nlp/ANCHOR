...
def process_alarm(engine, item, collect_matches=False, register_trigger=True):
    alarm = item["alarm"]
...
def build_simulated_now_ts_getter(valid_alarms, speedup):
...
def refresh_process_progress(process_progress):
